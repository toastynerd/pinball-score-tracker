...
def main():
    parser = argparse.ArgumentParser(description="Train PaddleOCR model for pinball score recognition")
    parser.add_argument("--config", type=str, help="Path to training configuration file")
    parser.add_argument("--data-dir", type=str, default="data/paddleocr_training", 
                        help="Directory containing training data")
    parser.add_argument("--output-dir", type=str, default="models/pinball_ocr",
