...
class PinballOCREvaluator:
    ...
    def calculate_edit_distance(self, pred: str, true: str) -> int:
        ...
        return len(pred) + len(true) - 2 * len(SequenceMatcher(None, pred, true).get_matching_blocks())
    ...
    def evaluate_dataset(self, test_data_path: str, metadata_file: str) -> EvaluationMetrics:
        ...
        correct_characters = sum(
            len(r['ground_truth_normalized']) * r['character_accuracy'] 
            for r in results
        )
