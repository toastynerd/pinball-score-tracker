...
class PinballImagePreprocessor:
    ...
    def preprocess_dataset(self, input_dir: str, output_dir: str,
        ...
        logger.info(f"Preprocessing complete: {stats['processed_successfully']}/{stats['total_images']} successful")
...
def main():
    ...
    parser.add_argument('--width', type=int, help='Target width (maintains aspect ratio if not set)')
